...
> concorrência e thread safety, nil/optional handling, race conditions.
> Retorne: lista de issues com severidade e onde exatamente no código.

**Revisor 3 — Project Conventions:**
> Leia o CLAUDE.md do projeto + arquivos modificados. Avalie: conformidade com as convenções
> do stack declaradas no CLAUDE.md, armadilhas documentadas, coding style rules.
